  ...
  return (
    <div className="min-h-screen bg-[#060709] text-white overflow-x-hidden">
      ...
      <section className="py-16 px-6 border-t border-b border-white/5">
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 text-center">
          {STATS.map((s) => (
            <div key={s.label}>
              <div className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight">{s.value}</div>
              <div className="text-xs sm:text-sm text-gray-500 mt-2 uppercase tracking-wider">{s.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="planos" className="py-24 px-6 border-t border-white/5">
        ...
        <div className="max-w-3xl mx-auto grid md:grid-cols-2 gap-6">
          {PLANS.map((plan) => (
            <div
              key={plan.name}
              className={`rounded-2xl border p-5 sm:p-7 flex flex-col gap-5 relative overflow-hidden ${
                plan.highlight
      ...
      <section className="py-24 px-6 border-t border-white/5 text-center">
        <div className="max-w-3xl mx-auto">
          <div className="border border-white/5 rounded-3xl px-5 sm:px-8 py-10 sm:py-14 bg-[#0d0f18] relative overflow-hidden">
