 ...
 */
export declare const notificationsTable: import("drizzle-orm/sqlite-core").SQLiteTableWithColumns<{
    name: "notifications";
    schema: undefined;
    columns: {
...
export declare const insertNotificationSchema: z.ZodObject<any>;
