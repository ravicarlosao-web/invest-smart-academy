...
export default function Cadastrar() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.ok) {
      toast.success("Conta criada com sucesso! Bem-vindo ao TradeAcademy.");
      navigate("/dashboard");
    } else {
  ...
  return (
    <div className="min-h-screen bg-[#0f1117] text-white flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm bg-[#1a1d27] border border-white/10 rounded-2xl p-8">
        ...
        <p className="text-gray-400 text-sm mb-6">Começa gratuitamente em menos de 1 minuto.</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <Button
            ...
            className="bg-cyan-500 hover:bg-cyan-600 text-white font-semibold py-5 rounded-xl w-full mt-2"
          >
